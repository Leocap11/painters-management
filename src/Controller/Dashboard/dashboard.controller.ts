...
export class DashboardController {
    constructor(private readonly getAllDashboardCountsUseCase: GetAllDashboardCountsUseCase) { }
    ...
    async getAllCounts(): Promise<ResponseDTO<DashboardCountsResponseDTO>> {
        ...
        return buildSuccessResponse(FromDashboardCountsModelToDashboardCountsResponseDTO(counts))
    }
